...
public open class GenerateGraphVizPngTask @Inject constructor(objects: ObjectFactory) : DefaultTask() {
  @get:InputDirectory
  ...
  @get:OutputFile
  public val pngFile: RegularFileProperty = objects.fileProperty()

  @get:OutputFile
  public val errorFile: RegularFileProperty = objects.fileProperty()
